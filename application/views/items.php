                  ...
                  <div class="box box-info ">
                      ...
                      <?= form_open('#', array('class' => 'form', 'id' => 'items-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                        ...
                        <div class="box-body">
                           ...
                           <!--   </div>-->
                           <!--</div>-->
                           <input type="hidden" class="form-control" id="item_code" name="item_code" placeholder="" value="<?php print $item_code; ?>" >
                           <div class="row">
                              <div class="form-group col-md-4">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4 <?=tax_disable_class()?>">
                                 ...
                                 <select class="form-control select2" id="tax_id" name="tax_id"  style="width: 100%;" >
                                    <?php
                                       $query1="SELECT * FROM db_tax WHERE STATUS=1 ORDER BY id DESC";
                                       $q1=$this->db->query($query1);
                                       if($q1->num_rows($q1)>0)
                                        {
