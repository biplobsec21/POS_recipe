...
<body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <div class="box box-info ">
                     ...
                     <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
                        ...
                        <div class="box-body">
                           ...
                           <!-- ADD THIS NEW ROW FOR STOCK FILTER -->
                           <div class="form-group">
                              <label for="stock_filter" class="col-sm-2 control-label">Stock Status</label>
                              <div class="col-sm-3">
                                 <select class="form-control select2" id="stock_filter" name="stock_filter" style="width: 100%;">
                                    <option value="">All Stock</option>
                                    <option value="zero">Zero Stock</option>
                                    <option value="non_zero">Non-Zero Stock</option>
                                 </select>
                                 <span id="stock_filter_msg" style="display:none" class="text-danger"></span>
                              </div>
                           </div>
                        </div>
                        <!-- /.box-body -->
   ...
   <script type="text/javascript">
      function load_reports() {
         ...
         var stock_filter = document.getElementById("stock_filter").value.trim(); // ADD THIS LINE

         $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');

         // UPDATE THIS AJAX CALL - ADD stock_filter
         $.post("get_stock_report", {
            brand_id: brand_id,
            category_id: category_id,
            item_id: $("#item_id").val(),
            stock_filter: stock_filter // ADD THIS LINE
         }, function(result) {
