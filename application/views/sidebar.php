...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="recipe-list-active-li recipe-active-li production-list-active-li production-active-li treeview">
          ...
          <ul class="treeview-menu">
            <?php if ($CI->permissions('recipe_add')) { ?>
              <li class="recipe-active-li"><a href="<?php echo $base_url; ?>recipe/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_recipe'); ?></span></a></li>
            <?php } ?>
      ...
      <?php } ?>
      <li class="payment_types_list-active-li payment_types-active-li">
        <a href="<?php echo $base_url; ?>Subscription/view"><i class="fa fa-list "></i>
          <span>
            Subscription
          </span>
        </a>
