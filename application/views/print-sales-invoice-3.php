...
<table autosize="1" style="overflow: wrap;font-size:14px;" id='mytable' align="center" width="100%" height='100%'  cellpadding="0" cellspacing="0"  >
        ...
        <th colspan="16">
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
                <!-- First Half -->
                <td colspan="4">
                  <img src="<?= base_url('uploads/company/'.$company_logo);?>" width='50%' >
                </td>
...
<tfoot>
  ...
  <tr class="bg-sky">
    ...
    <td colspan="2" class='text-bold text-right' ><b><?php echo number_format(($tot_sales_price),2); ?></b></td>
            <td colspan="1" class='text-bold text-right'><?=number_format($tot_qty,2); ?></td>

    <td colspan="1" class='text-bold text-right'><b><?php echo number_format(($tot_discount_amt),2); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format(($tot_total_cost),2); ?></b></td>
  </tr>
  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('subtotal'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format($tot_total_cost,2); ?></b></td>
  </tr>


  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('other_charges'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format($other_charges_amt,2); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('discount_on_all'); ?>(<?= $discount_to_all_input." ".$discount_to_all_type; ?>)</b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format($tot_discount_to_all_amt,2); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('grand_total'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format($grand_total,2); ?></b></td>
  </tr>

  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('invoice_paid'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format($paid_amount,2); ?></b></td>
  </tr>
  <tr>
    <td colspan="10" class='text-right'><b><?= $this->lang->line('invoice_due'); ?></b></td>
