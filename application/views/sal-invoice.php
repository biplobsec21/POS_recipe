  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (!empty($customer_country)) {
        $row = $this->db->query("select country from db_country where id='$customer_country'")->row();
        $customer_country = $row ? $row->country : '';
      }
      if (!empty($customer_state)) {
        $row = $this->db->query("select state from db_states where id='$customer_state'")->row();
        $customer_state = $row ? $row->state : '';
      }
