...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?= $page_title; ?>
                    <small>Add New Production</small>
                </h1>
                        ...
                        <div class="box box-info ">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control only_currency" id="batch_quantity" name="batch_quantity" placeholder="" value="" autofocus>
                            ...
                            <div class="box-footer">
                                <div class="col-sm-8 col-sm-offset-2 text-center">
                                    <div class="col-md-3 col-md-offset-3">
                                        <button type="button" id="save" class="btn btn-block btn-success" title="Save Production">Save</button>
                                    </div>
                                    <div class="col-sm-3">
    ...
    <script>
        ...
        // Save production with complete protection
        // Save production - For TEXT response
        $(document).ready(function() {
            ...
            $("#save").off('click').on('click', function(e) {
                ...
                // REMOVE dataType: 'json' for text response
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.toString().trim() === 'success') {
                            toastr.success('Production batch saved successfully!');
                            setTimeout(function() {
                                window.location.href = base_url + 'production';
                            }, 1000);
                        } else {
                            toastr.error(response.toString());
                            saveBtn.prop('disabled', false).html(originalText);
                        }
                    },
                    error: function(xhr, status, error) {
                        isSubmitting = false;
                        toastr.error('Failed to save production batch. Please try again.');
                        saveBtn.prop('disabled', false).html(originalText);
                    }
                });
