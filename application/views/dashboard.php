...
<body class="hold-transition skin-blue sidebar-mini">
  <!-- Hidden base_url for JavaScript -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-dream-maroon">
              <div class="inner text-uppercase">
                <h3><?= $tot_pur; ?></h3>
                <p><?= $this->lang->line('purchase_invoice'); ?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-dream-green">
              <div class="inner text-uppercase">
                <h3><?= $tot_sal; ?></h3>
                <p><?= $this->lang->line('sales_invoice'); ?></p>
              </div>
              <div class="icon">
                <i class="ion ion-ios-paper-outline"></i>
              </div>
  ...
  <!-- Notice Modal -->
  <div id="noticeModal" class="hidden fixed inset-0 backdrop-blur-md bg-white bg-opacity-20 flex items-center justify-center p-4 z-50" style="font-family: 'Hind Siliguri', sans-serif;">
    <div class="max-w-4xl w-full bg-white shadow-2xl rounded-xl overflow-hidden border-t-4 border-indigo-600">

      <div class="bg-white p-6 border-b border-gray-100 flex justify-between items-center">
        <div>
          <h1 class="text-4xl font-bold text-gray-800">জরুরী বিজ্ঞপ্তি</h1>
          <p class="text-gray-700 text-lg font-bold mt-1">সার্ভার ও সফটওয়্যার বিভাগ</p>
        </div>
        <button onclick="closeNoticeModal()" class="text-gray-500 hover:text-gray-700 transition">
      ...
      <div class="p-8 pb-4">
        <span class="inline-block bg-red-100 text-red-600 text-sm font-bold px-4 py-2 rounded-full mb-4">
          পেমেন্ট আপডেট
        </span>

        <p class="text-2xl text-gray-700 leading-relaxed font-bold">
          আগামী <span class="text-indigo-700 font-black">মার্চ ২০২৬</span> থেকে সার্ভার ও সফটওয়্যারের ম্যান্টেইনেন্স ফী <span class="text-indigo-700 font-black">২০০০ টাকা</span> করে প্রদান করার জন্য অনুরোধ করা হইলো।
        </p>

        <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200 flex items-center gap-3">
          ...
          <div>
            <p class="text-lg font-bold text-gray-700">প্রয়োজনে যোগাযোগঃ</p>
            <a href="tel:01937913457" class="text-2xl font-black text-gray-800 hover:text-indigo-600 transition">
              ০১৯৩৭৯১৩৪৫৭
            </a>
          </div>
        </div>
      ...
      <div class="px-8 pb-8">
        <button onclick="closeNoticeModal()" class="block w-full bg-red-600 hover:bg-indigo-700 text-white text-center font-bold py-3 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1">
          Close
        </button>
      </div>

      <div class="bg-gray-50 p-4 text-center border-t border-gray-100">
        <p class="text-xs text-gray-400">&copy; ২০২৬ সার্ভার অ্যাডমিনিস্ট্রেশন</p>
      </div>
  ...
  <script>
    ...
    // Optional: Open modal on page load
    window.addEventListener('load', function() {
      <?php if (getenv('SHOW_NOTICE') === 'true' || getenv('SHOW_NOTICE') === '1'): ?>
        openNoticeModal();
      <?php endif; ?>
    });
  </script>
