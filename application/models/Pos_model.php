...
class Pos_model extends CI_Model
{
	...
	public function get_details()
	{
		...
		if ($q2->num_rows() > 0) {
			foreach ($q2->result() as $res2) {
				...
				$table .= '<div class="col-md-4 col-xs-6 " id="item_parent_' . $i . '" ' . $disabled . ' data-toggle="tooltip" title="' . $res2->item_name . '" style="padding-left:5px;padding-right:5px;">
	...
	public function hold_list_save_update()
	{ //Save or update sales
		$this->db->trans_begin();
		extract($this->xss_html_filter(array_merge($this->data, $_POST, $_GET)));
