...
function record_customer_payment($customer_id = null)
{
  ...
  if (empty($customer_id)) {
    ...
    $CI->db->query("delete from db_customer_payments where customer_id=" . (int)$customer_id);
    $customer_id_str = " and b.customer_id=" . (int)$customer_id . " ";
  }
...
function record_supplier_payment($supplier_id = null)
{
  ...
  if (empty($supplier_id)) {
    ...
    $CI->db->query("delete from db_supplier_payments where supplier_id=" . (int)$supplier_id);
    $supplier_id_str = " and b.supplier_id=" . (int)$supplier_id . " ";
  }
...
{
  return ((int)get_site_details()->disable_tax === 1) ? true : false;
}
